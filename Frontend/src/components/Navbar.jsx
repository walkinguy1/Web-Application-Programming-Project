...
export default function Navbar() {
  ...
  return (
    <>
      {/* Custom Hyper-Realistic Thunder & Color Shift Animation */}
      <style>
        {`
          ...
          .animate-thunder-bolt {
            animation: electric-strike 4s infinite;
          }
          
          .animate-box-electric {
            animation: box-glow 4s infinite;
          }
        `}
      </style>
          ...
          >
            <div className={`p-1.5 rounded-lg transition-all duration-500 shadow-lg ${
              ...
              {isLiquorMode ? (
                ...
                <Zap size={22} className="text-white fill-current animate-thunder-bolt" />
              )}
            </div>
